...
``eigenvec_viewer.py`` is a script for printing eigenvectors in a user-friendly layout. Eigenvectors are generated by script ``chiq_post.py`` with option ``vector=true``. See :ref:`Algorithm_Eigen` for the definition of the eigenvectors.

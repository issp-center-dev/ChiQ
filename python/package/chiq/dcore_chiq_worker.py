...
from dcore.sumkdft_workers.worker_base import SumkDFTWorkerBase, setup_sk

from chiq.sumk_dft_chi import SumkDFTChi
...
class SumkDFTWorkerBSE(SumkDFTWorkerBase):
    ...
    def run(self):
        ...
        sk = SumkDFTChi(
            hdf_file=self.model_hdf5_file,
            use_dft_blocks=False,
            h_field=0.0,
            dft_data_fbz=dft_data_fbz,
            h5_compression=self.params["h5_compression"],
            h5_compression_opts=self.params["h5_compression_opts"],
        )

...
.. code-block:: bash
    ...
    eigenvec_viewer [-h] [-a ATOMS] [--spin-orbit | --spin-charge]
...
``eigenvec_viewer`` is a script for printing eigenvectors in a user-friendly layout. Eigenvectors are generated by script ``chiq_post`` with option ``vector=true``. See :ref:`Algorithm_Eigen` for the definition of the eigenvectors.
...
Without any option, ``eigenvec_viewer`` simply prints the eigenvectors as follows:

.. code-block:: console

    $ eigenvec_viewer chi_q_eigenvec.00.00.00.dat
...
.. code-block:: console
    ...
    $ eigenvec_viewer chi_q_eigenvec.00.00.00.dat -a 1
    ...
...
.. code-block:: console
    ...
    $ eigenvec_viewer chi_q_eigenvec.00.00.00.dat -a 1 --spin-charge
    ...
...
.. code-block:: console
    ...
    $ eigenvec_viewer chi_q_eigenvec.16.16.00.dat -a 1 --spin-charge

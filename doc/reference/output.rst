...
This file is generated by ``chiq_post``, which contains :ref:`the eigenvalues <Algorithm_Eigen_values>` or :ref:`the linear combinations <Algorithm_Eigen_linear_combination>` of the two-particle susceptibilities :math:`\chi_{\xi}(\boldsymbol{q}, i\Omega_m)` or :math:`\chi_{\gamma\gamma}(\boldsymbol{q}, i\Omega_m)`, respectively.
...
These files are generated by ``chiq_post`` with ``vector = true`` in ``[chiq_post]``, which contain :ref:`the eigenvectors <Algorithm_Eigen>` of the two-particle susceptibilities, :math:`U_{kl}^{(\xi)}(\boldsymbol{q}, i\Omega_m)`.
...
These files can be analyzed by :ref:`eigenvec_viewer <program_eigenvec_viewer>`.

``chi_q_eigen_path.pdf``
------------------------

This file is generated by ``plot_chiq_path``, which shows the plot of the susceptibilities :math:`\chi_{\xi}(q)` along the path.

``chi_q_eigen_path_inv.pdf``
----------------------------

This file is generated by ``plot_chiq_path``, which shows the plot of the inverse susceptibilities :math:`1/\chi_{\xi}(q)` along the path.

``I_r_eigen_distance.pdf``
----------------------------

This file is generated by ``plot_Ir``, which shows the plot of the intersite interaction :math:`I(r)` as a function of the distance from the origin.

``chi_q_eigen_path.dat``
------------------------

This file is generated by ``plot_chiq_path`` or ``plot_Ir`` by option ``--data_out FILENAME``.
...
The first column is distance from the origin along the path (``plot_chiq_path``) or the distance from the origin (``plot_Ir``).
